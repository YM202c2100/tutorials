...
export const GithubIcon:React.FC<IconProps> = ({ className, ...rest }) => (
  <motion.a href="https://github.com" target="_blank" whileHover={{scale:1.1, y:-2}} whileTap={{scale:0.9}} className={className}>
    <svg
...
export const TwitterIcon:React.FC<IconProps> = ({ className, ...rest }) => (
  ...
  <motion.a href="https://x.com" target="_blank" whileHover={{scale:1.1, y:-2}} whileTap={{scale:0.9}} className={className}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      height="1em"
...
export const LinkedInIcon:React.FC<IconProps> = ({ className, ...rest }) => (
  ...
  <motion.a href="https://linkedIn.com" target="_blank" whileHover={{scale:1.1, y:-2}} whileTap={{scale:0.9}} className={className}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      height="1em"
...
export const PinterestIcon:React.FC<IconProps> = ({ className, ...rest }) => (
  <motion.a href="https://pinterest.jp" target="_blank" whileHover={{scale:1.1, y:-2}} whileTap={{scale:0.9}} className={className}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      height="1em"
...
export const DribbbleIcon:React.FC<IconProps> = ({ className, ...rest }) => (
  <motion.a href="https://dribbble.com" target="_blank" whileHover={{scale:1.1, y:-2}} whileTap={{scale:0.9}} className={className}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      height="1em"
